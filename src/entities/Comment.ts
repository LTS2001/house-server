...
export class Comment {
  ...
  @ManyToOne(() => HouseInfo, (houseInfo) => houseInfo.comments, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
  ...
  @ManyToOne(() => UserLandlord, (userLandlord) => userLandlord.comments, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
  @JoinColumn([{name: "landlord_id", referencedColumnName: "id"}])
  landlord: UserLandlord;

  @ManyToOne(() => UserTenant, (userTenant) => userTenant.comments, {
    onDelete: "NO ACTION",
    onUpdate: "NO ACTION",
  })
