...
(
    ...
    tenant_id              int                                not null comment '租客id',
    house_id               int                                not null comment '房屋id',
    last_electricity_meter int      default 0                 null comment '上个月的电表记录值',
    electricity_meter      int      default 0                 not null comment '电表记录值',
    last_water_meter       int      default 0                 null comment '上个月的水表记录值',
    water_meter            int      default 0                 not null comment '水表记录值',
    last_fuel_meter        int      default 0                 null comment '上个月的燃气表记录值',
    fuel_meter             int      default 0                 not null comment '燃气表记录值',
